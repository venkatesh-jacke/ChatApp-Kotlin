...
class MessageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        messageAdapter= MessageAdapter(messages,intent.extras?.getString("roommate_img").toString(),intent.extras?.getString("my_img").toString(),this@MessageActivity)


        ivSend.setOnClickListener {
            FirebaseDatabase.getInstance().getReference("messages/"+chatRoomId).push().setValue(Message(FirebaseAuth.getInstance().currentUser?.email.toString(), roommate_email, etMessage.text.toString()))
    ...
    fun setupChatRoom(){
        FirebaseDatabase.getInstance().getReference("users/"+FirebaseAuth.getInstance().uid).addListenerForSingleValueEvent(object:
            ValueEventListener {
    ...
    fun attachMessageListener(chatRoomId: String) {
        FirebaseDatabase.getInstance().getReference("messages/"+ this.chatRoomId).addValueEventListener(object:ValueEventListener{
